...
class GR00TInference:
    ...
    def __init__(self, checkpoint_path: str, policy_setup: str):
        ...
        data_config = DATA_CONFIG_MAP["widowx_bridge_lerobot"] #fourier_gr1_worldvec_lite or widowx_bridge_lerobot
    ...
    def step(self, image: np.ndarray, obs_full: dict | None = None):
        ...
        if obs_full is not None:
            ...
            if tcp_pose is not None and len(tcp_pose) >= 7:
                ...
                quat = np.asarray(tcp_pose[3:7], dtype=np.float32)
        ...
        obs = {
            "video.image_0": video_array,
            "video.image_1": video_array,
            "video.image_2": video_array,
            "video.image_3": video_array,
